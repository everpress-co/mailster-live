jQuery(document).ready(function ($) {
	...
	var _mapcanvas = $('.mailster_live_map'),
		...
		actionhashes = [], activeuser,
		hiDPI = window.devicePixelRatio > 1,
		users = {},
		map, servertimestamp = 0, typecount = 0,timeout = null, timestamptimeout = null, invisible = false, isLive = true,
	...
	function timestamps() {
		...
		var d = Math.floor(new Date().getTime() / 1000), remove = $([]);
